                      ...
                      <div class="card-body">
                          ...
                          <div class="container-fluid">
                            ...
                            <div class="col-md-12 text-center">
                                <h6 style="font-weight: bolder;">No. Aplikasi: 00444520</h6>
                            </div>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                      <form>
                                              ...
                                              <div class="form-group col">
                                                              ...
                                                              <input class="form-control" type="text" value="2017/04/08" readonly>
                                                          </div>
                                      ...
                                      <form>
                                              ...
                                              <div class="form-group col">
                                                          ...
                                                          <div class="form-group col">
                                                              ...
                                                              <input class="form-control" type="text" value="50 Tahun" readonly>
                                                          </div>
                                                            
                                                            <div class="form-group col">
                                                              <label>Frekuensi Pembayaran Premi</label>
                                                              <input class="form-control" type="text" value="Bulanan" readonly>
                                                          </div>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                      <form>
                                              ...
                                              <div class="form-group col">
                                                              ...
                                                              <input class="form-control" type="text" value="INVESTRA PREMIER" readonly>
                                                          </div>
                              ...
                              <div class="row">
                                  <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                      <form>
                                              ...
                                              <div class="form-group col">
                                                  <label>Frekuensi Pembayaran Premi</label>
                                                  <input class="form-control text-dark" type="text" value="Bulanan" readonly>
                                              </div>
                                              ...
                                              <div class="form-group col">
                                                ...
                                                <div class="form-group col">
                                                  ...
                                                  <input class="form-control" type="text" value="2020/04/08" readonly>
                                              </div>
                              ...
                              <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                  <form>
                                          ...
                                          <div class="form-group col">
                                              ...
                                              <input class="form-control" type="text" value="Rp. 42.600" readonly>
                                          </div>
