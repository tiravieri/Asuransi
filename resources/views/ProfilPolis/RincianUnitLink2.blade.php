                                          ...
                                          <form>
                                              <div class="form-group col">
                                                  ...
                                                  <div class="filter-dropdown dropdown">
                                                    <button class="btn btn-block dropdown-toggle" type="button" style="box-shadow: none !important; color: grey; text-align: left; font-weight: normal;" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                      Pilih
                                                    </button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                      <a class="dropdown-item" href="RincianUnitLink2">Pilih</a>
                                                      <a class="dropdown-item" data-toggle="modal" data-target="#ModalLPTBaru">LPT Polis Baru</a>
                                                      <a class="dropdown-item" href="RincianUnitLink2_2#tanggaldate">LPT Bulanan</a>
                                                    </div>
                                                  </div>
                                              </div>
                                          </form>
