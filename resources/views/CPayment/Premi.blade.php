            ...
            <div class="card-body">
                <div class="container-fluid">
                  <p style="font-size: 13px; text-align: center;">Bidang dengan tanda bintang (*) sebelum bidang wajib diisi</p>
                      ...
                      <table class="table table-bordered table-striped text-center table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody class="bg-light">
                          <tr>
                              ...
                              <td>4.500.000</td>
                              <td>
                                  <input type="checkbox" id="bayarCheck" onchange="window.location.href='PremiCheck'">
                              </td>
                          </tr>
                          <tr>
                              <td>2</td>
                    ...
                    <fieldset disabled style="padding-top: 2%;">
                    ...
                    <div class="row">
                          ...
                          <div class="col-12 float-right">
                              <button class="btn btn-warning disabled">Bayar</button>
                          </div>
                    </div>
